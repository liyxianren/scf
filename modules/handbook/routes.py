...
from core.storage import get_upload_dir, get_generated_dir, save_uploaded_file, save_text_content
from modules.handbook.services.agent import HandbookAgent
from modules.handbook.services.exporter import HandbookExporter
...
def _generate_handbook_background(handbook_id):
...
def handbook_generator():
    return render_template("handbook/generator.html")


@handbook_bp.route("/library")
def handbook_library():
    return render_template("handbook/library.html")


@handbook_bp.route("/library/<int:handbook_id>")
def handbook_detail(handbook_id):
    return render_template("handbook/detail.html", handbook_id=handbook_id)
...
def api_generate_handbook(handbook_id):
    ...
    TaskRunner.run_async(_generate_handbook_background, handbook_id)
