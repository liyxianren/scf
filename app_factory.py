...
def _build_base_app(config_class, config_overrides):
    app = Flask(__name__)
...
def _register_public_module_blueprints(app):
...
def _register_oa_blueprint(app):
...
def create_app(
    ...
    *,
    ...
    app = _build_base_app(config_class, config_overrides)

    _register_public_module_blueprints(app)
    _register_oa_blueprint(app)
    _register_auth_blueprint(app)
    _register_public_page_routes(app)
...
def create_oa_app(
    ...
    *,
    ...
    app = _build_base_app(config_class, config_overrides)
    app.config['AUTH_BASE_TEMPLATE'] = 'oa/base.html'
...
def _migrate_add_columns():
    ...
    migrations = [
        ...
        "ALTER TABLE course_schedules ADD COLUMN meeting_provider TEXT",
        "ALTER TABLE course_schedules ADD COLUMN meeting_status TEXT DEFAULT 'not_required'",
        "ALTER TABLE course_schedules ADD COLUMN meeting_join_url TEXT",
        "ALTER TABLE course_schedules ADD COLUMN meeting_external_id TEXT",
        "ALTER TABLE course_schedules ADD COLUMN meeting_code TEXT",
        "ALTER TABLE course_schedules ADD COLUMN meeting_password TEXT",
        "ALTER TABLE course_schedules ADD COLUMN meeting_created_at TIMESTAMP",
        "ALTER TABLE course_schedules ADD COLUMN meeting_ended_at TIMESTAMP",
        "ALTER TABLE course_schedules ADD COLUMN import_run_id INTEGER REFERENCES schedule_import_runs(id)",
        "ALTER TABLE course_schedules ADD COLUMN is_cancelled BOOLEAN DEFAULT 0",
        "ALTER TABLE course_schedules ADD COLUMN cancelled_at TIMESTAMP",
        "ALTER TABLE course_schedules ADD COLUMN cancel_reason TEXT",
        "ALTER TABLE course_schedules ADD COLUMN cancelled_by_user_id INTEGER REFERENCES users(id)",
        "ALTER TABLE student_profiles ADD COLUMN excluded_dates TEXT",
        "ALTER TABLE users ADD COLUMN teacher_work_mode TEXT DEFAULT 'part_time'",
        "ALTER TABLE users ADD COLUMN default_working_template_json TEXT",
        "ALTER TABLE enrollments ADD COLUMN delivery_preference TEXT DEFAULT 'unknown'",
        "ALTER TABLE leave_requests ADD COLUMN makeup_schedule_id INTEGER REFERENCES course_schedules(id)",
        "ALTER TABLE leave_requests ADD COLUMN makeup_available_slots_json TEXT",
        "ALTER TABLE leave_requests ADD COLUMN makeup_excluded_dates_json TEXT",
        "ALTER TABLE leave_requests ADD COLUMN makeup_preference_note TEXT",
        ...
        "ALTER TABLE course_feedback ADD COLUMN student_performance TEXT",
        "ALTER TABLE course_feedback ADD COLUMN ai_content_draft TEXT",
        "ALTER TABLE course_feedback ADD COLUMN ai_draft_status TEXT DEFAULT 'pending'",
        "ALTER TABLE course_feedback ADD COLUMN ai_model_provider TEXT",
        "ALTER TABLE course_feedback ADD COLUMN ai_generated_at TIMESTAMP",
        "ALTER TABLE course_feedback ADD COLUMN ai_source_type TEXT",
        "ALTER TABLE reminder_events ADD COLUMN due_at TIMESTAMP",
        "ALTER TABLE reminder_deliveries ADD COLUMN provider_message_id TEXT",
        "ALTER TABLE reminder_deliveries ADD COLUMN provider_response_json TEXT",
        "ALTER TABLE reminder_deliveries ADD COLUMN last_attempt_at TIMESTAMP",
        "ALTER TABLE reminder_deliveries ADD COLUMN delivered_at TIMESTAMP",
        "ALTER TABLE reminder_deliveries ADD COLUMN failed_at TIMESTAMP",
        "ALTER TABLE reminder_deliveries ADD COLUMN error_message TEXT",
    ]
...
def _cleanup_expired():
    """Placeholder expired-record cleanup; kept as a hook for shared startup wiring."""
    return None
...
def _register_public_page_routes(app):
